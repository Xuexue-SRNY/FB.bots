...
[Join our Discord](https://discord.gg/aeR3Eme)
...
6. Copy and paste the contents of either [`free-agario-bots.vanilla.user.js`](https://github.com/Xuexue-SRNY/FB.bots/raw/master/free-agario-bots.vanilla.user.js) or [`free-agario-bots.ogario.user.js`](https://github.com/Xuexue-SRNY/FB.bots/raw/master/free-agario-bots.ogario.user.js) into a new Tampermonkey userscript and save it
...
3. Run `git clone https://github.com/Xuexue-SRNY/FB.bots.git` command
4. Run `cd Fb.bots` command
